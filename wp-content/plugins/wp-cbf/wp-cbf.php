 ...
 *
 * @link              http://www.juliesmike.com/
 * @since             1.0.0
 * @package           Wp_Cbf
 *
 * @wordpress-plugin
 * Plugin Name:       WP Cleanup and base Functions
 * Plugin URI:        https://github.com/motbsitu/wpplugin
 * Description:       Head section cleanup, custom settings used on every website setup as images settings, privacy and basic admin customizations. 
 * Version:           1.0.0
 * Author:            Julie S. Mike
 * Author URI:        http://www.juliesmike.com/
 * License:           GPL-2.0+
