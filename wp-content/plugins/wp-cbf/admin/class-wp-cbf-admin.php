 ...
 * @package    Wp_Cbf
 * @subpackage Wp_Cbf/admin
 * @author     Julie S. Mike <julie@juliesmike.com>
 */
class Wp_Cbf_Admin {
...
public function add_plugin_admin_menu(){
	//settings for the plugin on settings menu
...
public function add_action_links( $links ){
	$settings_link = array(
		'<a aref="' . admin_url( 'options-general.php?page=' . $this->plugin_name ) . '">' . __('Settings', $this->plugin_name) . '</a>',
   );
